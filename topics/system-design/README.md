...
|---|---|---|---|---|
| System Design Fundamentals & Interview Framework | `fundamentals-and-framework` | very-high | beginner | ✅ (80 MCQs · 36 adv/expert) |
...
| Databases: SQL vs NoSQL, Indexing, Sharding & Replication | `databases-sql-nosql-sharding-replication` | very-high | intermediate | ✅ (76 MCQs · 36 adv/expert) |
| CAP Theorem & Consistency Models | `cap-theorem-and-consistency` | high | advanced | ✅ (75 MCQs · 33 adv/expert) |
| Message Queues, Streaming & Asynchronous Processing | `message-queues-and-async` | high | intermediate | ✅ (76 MCQs · 35 adv/expert) |
| Microservices, Monolith & API Design | `microservices-monolith-api-design` | high | intermediate | ✅ (75 MCQs · 33 adv/expert) |
...
| Resilience, Fault Tolerance & Design Trade-offs Deep-Dive | `resilience-tradeoffs-deep-dive` | very-high | advanced | ✅ (80 MCQs · 37 adv/expert) |
