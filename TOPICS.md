...
- [System Design](#system-design) — 23 core + 8 advanced deep-dives + 26 AWS topics (57)
...
Folder: `topics/system-design/` · 23 core topics + 8 advanced/expert deep-dive topics + 31 AWS System Design topics (`aws-` slug prefix, incl. a 5-topic AWS SaaS multi-tenancy architecture cluster: foundations, isolation patterns, tenant identity and routing, data partitioning, metering/tiering/throttling) + a 7-topic AWS Cloud Design Patterns group (`aws-cdp-` prefix — the 46-pattern clouddesignpattern.org catalog taught "classic intent → modern AWS equivalent") — see `topics/system-design/README.md` for the authoritative, current topic list. Session 9 added 8 senior/staff deep-dives (interview-method-scenario-playbooks, consensus-clocks-and-time, distributed-transactions-advanced, capacity-modeling-and-tail-latency, failure-theory-advanced, data-internals-storage-engines, probabilistic-data-structures, microservices-ddd-and-boundaries) and deepened 6 high-frequency core topics. (4 modern topics added in Session 6: event-driven/CQRS/saga/CDC, GenAI/LLM system design, real-time streaming, resilience trade-offs. AWS System Design sub-domain added in Session 8: compute EC2/ECS/EKS/Fargate/Lambda, serverless, API Gateway/AppSync, S3/EBS/EFS/FSx, DynamoDB, RDS/Aurora, ElastiCache/DAX, SQS/SNS/EventBridge, Kinesis/MSK, VPC/networking, Route 53/CloudFront, ELB/Auto Scaling, IAM, KMS/Cognito/WAF, CloudWatch/X-Ray, multi-region DR, analytics, microservices patterns, ML/GenAI/Bedrock, IoT/edge, migration, cost optimization, and end-to-end reference architectures).
